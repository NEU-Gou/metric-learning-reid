...
step =flipud([8 10; 16 16; 21 48; 64 24; 128 48]); % set the moving step size of the region.
BBoxsz =flipud([16 21; 32 32; 22 48; 64 24; 128 48]); % set the region size.
numP = [1 4 6 14 75];
imsz = [128 64];
numbin = 16;
numChn = 17;%14+2;
...
for i = 1:numel(I) % per person      
    ...
    if 0 %1--HOG FV;   0---LDFV
        ...
        for f = 1:num_frame
            ...
            for c = 1:3
                [tmpX,tmpY] = imgradientxy(reshape(tmp_hsv(:,:,3),imsz(1),imsz(2)));
